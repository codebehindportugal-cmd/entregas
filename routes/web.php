...
Route::middleware('auth')->group(function (): void {
    ...
    Route::middleware('role:admin')->group(function (): void {
        ...
        Route::post('/sepa/mandatos', [SepaController::class, 'store'])->name('sepa.mandatos.store');
        Route::get('/sepa/mandatos/{mandato}/editar', [SepaController::class, 'edit'])->name('sepa.mandatos.edit');
        Route::put('/sepa/mandatos/{mandato}', [SepaController::class, 'update'])->name('sepa.mandatos.update');
        Route::post('/sepa/mandatos/{mandato}/gerar', [SepaController::class, 'gerar'])->name('sepa.gerar');
        Route::get('/sepa/cobrancas/{cobranca}/xml', [SepaController::class, 'xml'])->name('sepa.cobrancas.xml');
        Route::delete('/sepa/cobrancas/{cobranca}', [SepaController::class, 'destroy'])->name('sepa.cobrancas.destroy');
        Route::put('/sepa/credor', [SepaController::class, 'credor'])->name('sepa.credor');
