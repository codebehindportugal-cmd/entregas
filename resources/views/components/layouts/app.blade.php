...
@auth
        ...
        $navGroups = auth()->user()->isAdmin()
            ? [
                [
                    'label' => 'Operações',
                    'items' => [
                        ['label' => 'Painel',              'route' => 'dashboard',               'active' => 'dashboard',              'icon' => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6'],
                        ['label' => 'Rotas',               'route' => 'entregas.index',          'active' => 'entregas.index',         'icon' => 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7'],
                        ['label' => 'Estado entregas',     'route' => 'entregas.verificacao',    'active' => 'entregas.verificacao',   'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4'],
                        ['label' => 'Preparar cabazes',    'route' => 'preparacao.index',        'active' => 'preparacao.*',           'icon' => 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z'],
                    ],
                ],
                [
                    'label' => 'Gestão',
                    'items' => [
                        ['label' => 'Listas Semanais',     'route' => 'lista-cabazes.index',     'active' => 'lista-cabazes.*',        'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2M9 12h6m-6 4h6'],
                        ['label' => 'Margens',              'route' => 'comparacao-cabazes.index','active' => 'comparacao-cabazes.*',   'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'],
                        ['label' => 'Produtos',             'route' => 'produtos.index',          'active' => 'produtos.*',             'icon' => 'M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z'],
                        ...
                        ['label' => 'Despesas',             'route' => 'despesas.index',          'active' => 'despesas.*',             'icon' => 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z'],
                    ],
                ],
                [
                    'label' => 'Clientes',
            ...
            : [
                [
                    'label' => null,
                    'items' => [
                        ['label' => 'Rota de hoje', 'route' => 'minhas-entregas.index', 'active' => 'minhas-entregas.*', 'icon' => 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7'],
                    ],
                ],
            ];

        // Flatten all items for mobile menu and active detection
        $navItems = collect($navGroups)->flatMap(fn($g) => $g['items'])->values()->all();
    ...
    <aside class="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col bg-[#14532d] lg:flex">
        ...
        {{-- Nav --}}
        <nav class="min-h-0 flex-1 overflow-y-auto px-3 py-4 space-y-5">
